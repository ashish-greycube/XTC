...
SELECT 
    ...
    IFNULL(emp.custom_employee_account_id, '') AS employee_account_id,  '' as blank_column, IFNULL(emp.custom_bank_code, '') AS bank_code,'' as blank_column,'' as blank_column,
    '' as blank_column,'' as blank_column,'' as blank_column,'' as blank_column,'' as blank_column,'' as blank_column,'' as blank_column,
